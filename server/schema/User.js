...
const userSchema = new mongoose.Schema({
    userName: {
        ...
        required: true,
        trim: true
    }, //User Name describes here
    password: { 
        type: String, 
        required: true, 
        trim: true 
    }, //Password is used to login
    about: { 
        type: String, 
        trim: true 
    }, //It is about a user 
    description: { 
        type: String, 
        trim: true 
    }, // It describes your details if you want
    mobileNo: {
        type: String,
        required: true, 
        unique: true
    ...
    notification: [
        {
            ...
            isRead: { 
                type: Boolean, 
                default: false 
            }, // It gives boolean if message is readed or not
            timeStamp: { 
                type: Date, 
                // default: Date.now 
            } //It gives time of message
        }
    ],
    isOnline: { 
        type: Boolean, 
